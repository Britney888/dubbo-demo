...
public class MethodTimeInterceptor {
    ...
    private static final String POINT  =
            "( execution (* com.example.dubboordersconsumer.controller..*.*(..)) || " +
                    "execution (* com.example.dubboordersconsumer.service.impl..*.*(..)) || " +
                    "execution (* com.example.dubboordersconsumer.client..*.*(..)) )";
