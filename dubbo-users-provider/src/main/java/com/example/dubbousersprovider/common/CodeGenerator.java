...
public class CodeGenerator {
    ...
    // 数据库 URL
    private static final String URL = "jdbc:mysql://rm-bp19jwbfno3ac0e0bno.mysql.rds.aliyuncs.com:3306/sinafq?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    private static final String DRIVER_NAME = "com.mysql.jdbc.Driver";
    // 数据库用户名
    private static final String USERNAME = "sinafq";
    // 数据库密码
    private static final String PASSWORD = "nb6G7HDJ";
    // @author 值
    private static final String AUTHOR = "";
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "com.example.dubbousersprovider";
    // xml文件路径
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir(projectPath + "/dubbo-users-provider/src/main/java");
    ...
    private static String scanner(String tip) {
        ...
        if (scanner.hasNext()) {
            ...
            if (!StringUtils.isEmpty(ipt)) {return ipt;}
        }
